...
app.get("/api/insertLost", (req, res) => {

    const userSql = `INSERT INTO User (User_Fname, User_Lname, User_Phone, User_Email) values ('Justin', 'Kappa', '222-123-1234', 'jkap@gmail.com');`
